    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 xl:gap-12 items-stretch mb-8 sm:mb-10 lg:mb-12">
          ...
          <div
            className={`lg:col-span-5 xl:col-span-5 flex flex-col justify-between transition-all duration-1000 ease-out ${
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-2.5 sm:gap-3">
              {leftFeatures.map((item) => (
                <div
                  key={item.id}
                  className={`flex items-center gap-3.5 p-2.5 sm:p-3 rounded-xl bg-white/[0.03] border border-white/[0.07] hover:border-gold-main/30 hover:bg-white/[0.05] transition-all duration-300 group/feat ${
          ...
          <div
            className={`lg:col-span-7 xl:col-span-7 flex flex-col justify-between transition-all duration-1000 delay-200 ease-out ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
        ...
        {/* ═══════════════════════════════════════════
            ...
            ═══════════════════════════════════════════ */}
        <div
          className={`bg-white rounded-xl sm:rounded-2xl shadow-sm hover:shadow-md border border-gray-100 px-4 sm:px-6 py-3 sm:py-3.5 transition-all duration-700 delay-300 ease-out ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
      ...
      {selectedService && (
        ...
        >
          ...
          >
            ...
            <div
              className={`p-5 sm:p-7 md:p-8 overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden ${
                isRTL ? "text-right" : "text-left"
              }`}
            >
                ...
                <div className="lg:col-span-7 flex flex-col gap-3.5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {selectedService.details.map((item, idx) => (
                      <div
                        key={idx}
                        className={`group p-3.5 sm:p-4 rounded-xl bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.08] hover:border-gold-main/40 transition-all duration-200 flex items-start gap-3 ${
                          isRTL ? "flex-row-reverse text-right" : "text-left"
                        }`}
                      >
