...
/**
 * SustainabilityHero - Premium Global Hero Banner for Solutions (Sustainability & Compliance):
 * - 100% matches the global KnowledgeCenterHero / CareersHero layout, aspect ratio, and typography.
 * - LTR (English): Text & Dark Backdrop on LEFT, background image visible on RIGHT.
 * - RTL (Arabic): Text & Dark Backdrop on RIGHT, background image visible on LEFT.
 * - Uses 100% global theme tokens (var(--color-card-dark), var(--color-primary), text-gradient-gold-animated).
 */
  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto px-3 sm:px-6 md:px-10 lg:px-16 xl:px-20 relative z-10">
        ...
        >
          {/* Aspect Ratio Container (Matches KnowledgeCenterHero) */}
          <div className="relative w-full aspect-[1.7/1] sm:aspect-[2.4/1] md:aspect-[2.6/1] lg:aspect-[2.9/1] min-h-[280px] sm:min-h-[420px] md:min-h-[460px]">
            {/* Background Image from Sustainability And Compliance Folder */}
            <Image
              src="/images/Sustainability And Compliance/sustainability and compliance.jpg"
              alt="Sustainability & Compliance - Leela Gulf FZC"
              fill
            ...
            >
              ...
              >
                ...
                <span className="text-gold-light">
                  {isRTL ? "الاستدامة والامتثال" : "SUSTAINABILITY & COMPLIANCE"}
                </span>
              </div>

              {/* Main Bold Heading (Matches Global Standard & Proportions) */}
              <h1
              ...
              >
                {isRTL ? (
                  <>
                    <span className="block">رؤى الخبراء</span>
                    <span className="block">
                      من أجل <span className="text-gradient-gold-animated">غدٍ مستدام.</span>
                    </span>
                  </>
                ) : (
                  <>
                    ...
                    <span className="block">
                      for a <span className="text-gradient-gold-animated">Sustainable Tomorrow.</span>
                    </span>
                  </>
                )}
              </h1>
